<template>
  <div class="h-94">
    ...
    >
      ...
      >
        <h2
          class="text-[#e42b00] text-center justify-center items-center text-6xl font-bold relative mb-4"
        >
          <span class="text-[#fff]">Contact&nbsp;</span> Us
        </h2>
        <p class="text-[#fff] font-bold text-xl relative mb-10 pb-2">
        ...
        <NuxtLink
          to="/contact"
          class="btn text-white bg-transparent relative font-bold border-2 border-white py-4 px-6 hover:text-[#e42b00] ease-in duration-200"
          >Contact Us Now
        </NuxtLink>
      </div>
    </div>
