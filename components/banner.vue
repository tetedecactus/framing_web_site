    ...
    <div class="bg-homeImg pr-[-4] border-4 border-black bg-center bg-fixed h-screen overflow-hidden">
      <div class="flex justify-start items-start">
        <div class="flex flex-col items-start text-justify mx-auto my-auto">
          ...
          <div class="gradient-btn flex flex-row border-4 border-[#e42b00] relative text-lg py-4 px-6 rounded-none">
            <a :href="telLink"><img class="mr-4 relative hover:scale-[1.15] ease-in duration-300" src="../assets/images/icons8-phone-50.png" width="30" alt=""></a>
            <a class="btn text-white bg-transparent relative font-bold hover:text-[#e42b00] ease-in duration-200" :href="telLink">Call us at 1-780-271-6505</a>
          </div>
        </div>
      </div>
    </div>
